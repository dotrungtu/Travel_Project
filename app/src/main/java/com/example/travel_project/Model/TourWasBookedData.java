...
public class TourWasBookedData {
    String placeName;
    String countryName;
    String price;
    String imageUrl;
    ...
    String email;
    public TourWasBookedData() {

    }

    public TourWasBookedData(String placeName, String countryName, String price, String imageUrl, String dePartures, String desCription,
